...
public class ThongKeTungNgayDenNgay extends JPanel {
    
    public ThongKeTungNgayDenNgay() {
        init();
    }
    ...
    private void addChart() {
        ...
        int namKetThuc = 12; 
        //setHeader
        barChart.setHeader(String.format("Thống kê doanh thu từ ngày %s đến ngày %s", "01/01/2005","01/01/2024"));
